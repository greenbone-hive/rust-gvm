...
After the final ordered #658–#664 family migration, the ledger contains exactly
1026 rows: zero `transitional`, 409 `canonical-request`, 474 `removed`, 131
...
and source correspondence. The separate retained-surface/removal audit remains
out of scope for #664.
